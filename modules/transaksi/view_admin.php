...
<section class="content-header">
  <h1>
    ...
    <!--<a class="btn btn-add btn-social pull-right" href="?module=form_transaksi&form=add">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              $query = mysqli_query($mysqli, "
                SELECT 
                  a.id_transaksi, a.tanggal, a.nama, b.nama_ruangan, 
                  a.mulai, a.selesai, a.keterangan, a.status
                FROM transaksi a, ruangan b where a.ruangan=b.id 
              ...
              while ($data = mysqli_fetch_assoc($query)) {
                ...
                echo "<tr>
                      ...
                      <td width='140'>$data[keterangan]</td>
                      <td width='80' class='center'>$data[status]</td>
                     
                      <td class='center' width='100'>
                        <div>
                          <a data-toggle='tooltip' data-placement='top' title='Ubah' class='btn btn-primary btn-sm' href='?module=form_transaksi&form=edit_admin&id=$data[id_transaksi]'>
                              <i style='color:#fff' class='glyphicon glyphicon-edit'></i>
                          </a>";
              ?>
                <!-- tambah departemen
            <td width='140'>$data[departemen]</td> -->
                <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="modules/transaksi/proses.php?act=delete&id=<?php echo $data['id_transaksi']; ?>" onclick="return confirm('Anda yakin ingin menghapus ID Transaksi <?php echo $data['id_transaksi']; ?> an. <?php echo $data['nama']; ?> ?');">
