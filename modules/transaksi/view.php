  ...
  <div class="row">
	...
	<div class="table-responsive">
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            "SELECT 
              a.id_transaksi, a.tanggal, a.nama, b.nama_ruangan, a.mulai, a.selesai, a.status, a.keterangan
            FROM transaksi a,ruangan b,USER c
            WHERE a.iduser=c.id_user AND a.ruangan=b.id AND a.iduser = '$user' 
