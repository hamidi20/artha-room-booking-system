...
<html>
  <head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="assets/css/custome.css" rel="stylesheet" type="text/css" />-->

     <style type="text/css">
      body { 
 background: url(../image/greenland.jpg) no-repeat center center fixed; 
